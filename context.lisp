...
(defun test8 ()
  (let ((context-parent (make-context)))
    (let ((context-mid (augment-context-with-field (make-context) 'container context-parent)))
      (let ((context (augment-context-with-field (make-context) 'container context-mid)))
        (set-shallow context-parent "hello" "parent world 5")
